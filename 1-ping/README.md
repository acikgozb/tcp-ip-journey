...
## Step 4: The Journey of a Packet - Part 1
...
3 - IP checks the source and destination address (the process we did in previous section), and determines whether the destination address lives on local or a remote network.
